    ...
    try {
      for (String oneConverter : serializedObjectMethods) {
        String classText = ""
            ...
            + "import java.util.ArrayList;\n"
            + "\npublic class Converter"+ getClassName(oneConverter) +" implements Converter {\n"
        ...
        this.outputClassesPath.add(new File(pomFileDirectory+File.separator+"Converter"+getClassName(oneConverter)+".java").toPath());
